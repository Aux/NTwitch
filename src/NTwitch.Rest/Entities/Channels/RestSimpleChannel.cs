...
namespace NTwitch.Rest
{
    public class RestSimpleChannel : RestEntity<ulong>, ISimpleChannel
    {
        ...
        // Videos
        /// <summary>  </summary>
        public Task<IReadOnlyCollection<RestVideo>> GetVideosAsync(uint limit = 25, uint offset = 0, RequestOptions options = null)    // Add parameters at some point
            => ChannelHelper.GetVideosAsync(Client, Id, limit, offset, options);
        /// <summary>  </summary>
        public Task<IReadOnlyCollection<RestClip>> GetClipsAsync(bool istrending = false, uint limit = 10, RequestOptions options = null)
            => ClientHelper.GetFollowedClipsAsync(Client, Id, istrending, limit, options);

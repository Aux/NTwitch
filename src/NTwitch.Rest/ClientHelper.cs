...
namespace NTwitch.Rest
{
    internal static class ClientHelper
    {
        ...
        internal static Task<IReadOnlyCollection<RestCheerInfo>> GetCheersAsync(TwitchRestClient client, ulong id, RequestOptions options)
        {
            throw new NotImplementedException();
        }
        ...
        public static Task<RestStream> GetStreamAsync(TwitchRestClient client, ulong id, StreamType type, RequestOptions options)
        {
            throw new NotImplementedException();
        }
        ...
        public static Task<RestUser> GetUserAsync(TwitchRestClient client, ulong id, RequestOptions options)
        {
            throw new NotImplementedException();
        }
        ...
        public static Task<IReadOnlyCollection<RestClip>> GetFollowedClipsAsync(TwitchRestClient client, ulong id, bool istrending, uint limit, RequestOptions options)
        {
            throw new NotImplementedException();
        }
